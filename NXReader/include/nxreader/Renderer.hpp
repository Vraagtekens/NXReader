...
class Renderer {
  public:
    ...
    void drawReader(const ReaderState &state, const AppSettings &settings, bool showSettings, bool showAnnotationSheet,
                    bool confirmDelete, int sheetOffset, bool showChrome);
    void selectWordAt(ReaderState &state, bool showChrome, int x, int y, bool extendSelection);
    void drawReaderTransition(const ReaderState &state, const AppSettings &settings, bool showChrome, int fromPage,
                              int toPage, int direction, int frame, int totalFrames);
  ...
  private:
    ...
    void drawReaderPageContent(const ReaderState &state, int page, bool reserveChromeSpace, int xOffset,
                               SDL_Color body);
